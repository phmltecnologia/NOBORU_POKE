-- Categorias + camadas de seleção (option_layers)
...
-- Camada tamanho (pokes prontos 1-4)
...
-- Monte seu poke (builder completo)
UPDATE menu_items SET option_layers = '[
